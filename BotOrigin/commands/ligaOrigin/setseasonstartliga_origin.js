...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('setseasonstartliga_origin')
    ...
    async execute(client, interaction, command){
        ...
        // Bratpfanne, 
        CurrentSeason.seasonData.setAlpineDriversLigaOrigin(['640308390072942617', 'entfernt']);
        // Adman, Scof
        ...
        try{
            cron.schedule(`${seasonStartSecondsOfDay} ${seasonStartMinutesOfDay} ${seasonStartHourOfDay} ${seasonStartDayofMonth} ${seasonStartMonth} *`, () => {
                if(CurrentSeason.seasonData.getSeasonCalendarLigaOrigin().length > 0){
                    ...
                    CurrentSeason.methodStorage.startFunction(client, interaction, CurrentSeason.seasonData, 427200000);
                }
