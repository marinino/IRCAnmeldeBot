...
module.exports = {
    ...
    async execute(client, interaction, command){
        ...
        const abmeldeChannel = CurrentSeason.seasonData.getAbmeldeChannelIDLiga2();
        ...
        var tempSubInPerCmd = CurrentSeason.seasonData.getSubInDriversPerCommandLiga2();
        var tempFreeCars = CurrentSeason.seasonData.getFreeCarsLiga2();
        var tempWithdrawnDrivers = CurrentSeason.seasonData.getWithdrawnDriversLiga2();
        var tempReinstatedDrivers = CurrentSeason.seasonData.getsubPersonListReinstatedDriversLiga2();


        if(driverIn != null){
            if(await CurrentSeason.methodStorage.checkDriverInLineup(driverIn, CurrentSeason.seasonData)){
            ...
            */
                ...
                if(driverIn){
                    ...
                    if(preCmdDriver != 'nicht besetzt'){
                        ...
                        CurrentSeason.seasonData.setWithdrawnDriversLiga2(tempWithdrawnDrivers);
                    ...
                    CurrentSeason.seasonData.setSubInDriversPerCommandLiga2(tempSubInPerCmd);
                    ...
                    CurrentSeason.seasonData.setFreeCarsLiga2(tempFreeCars);
            ...
            */
                ...
                if(driverIn){
                    ...
                    if(tempReactedToSubIn.has(preCmdDriver)){
                        messageEmbededAnmelden.reactions.resolve(tempReactedToSubIn.get(preCmdDriver)).users.remove(preCmdDriver);
                        tempReactedToSubIn.delete(preCmdDriver);
                        CurrentSeason.seasonData.setReactedToSubInLig2(tempReactedToSubIn);
                    }
