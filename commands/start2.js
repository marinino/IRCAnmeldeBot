    ...
    if(!fromForceRemove &&
      ...
      if(subDriverID && subDriverID != 'nicht besetzt'){
        ...
        console.log(`${client.guilds.cache.get(discordID).members.cache.get(driverToStart).user.username} bekommt seinen Stammplatz wieder -- ${date}`);
              ...
              (client.guilds.cache.get(discordID).members.cache.get(withdrawnDriversLiga2[withdrawnDriversLiga2.length - 1]).roles.cache.has(stammfahrerRolleIDLiga2) ||
              client.guilds.cache.get(discordID).members.cache.get(withdrawnDriversLiga2[withdrawnDriversLiga2.length - 1]).roles.cache.has(ersatzfahrerRolleIDLiga2)) &&
              checkIfCarIsFree(client, carToTake)){
...
module.exports = {
    name: 'start2',
    aliases: ['anmelden2', 'abmelden2', 'removeabmeldung2', 'removeanmeldung2',
              'forceremove2', 'forcein2', 'forcefree2', 'end2', 'removefromwaitlist2', 'placedriveronwaitlist2',
              'shufflewaitlistfirst2', 'shufflewaitlistlast2', 'shufflewaitlistdown2', 'shufflewaitlistup2', 'changecockpit2'],
    ...
    async execute(client, message, cmd, args, Discord){
      ...
      if(cmd === 'anmelden2' && message.member.roles.cache.has(rennleiterRolleID)){
        ...
        }else if(driversSubInPerCommandLiga2.includes(args[0].slice(2,20))){
      ...
      if(cmd === 'abmelden2' && message.member.roles.cache.has(rennleiterRolleID)){
        if(!args[0]){
          message.reply('Bitte gebe den User an')
        }else if(driversWithdrawnPerCommandLiga2.includes(args[0].slice(2,20))){
      ...
      if(cmd == 'removefromwaitlist2' && (message.member.roles.cache.has(rennleiterRolleID))){
        if(args[0]){
          ...
          if(args[0] - 1 < subPersonListReinstatedDriversLiga2.length){
            userToRemoveID = subPersonListReinstatedDriversLiga2[args[0] - 1]
          }else if(args[0] - 1 < subPersonListReinstatedDriversLiga2.length + subPersonListLiga2.length) {
            userToRemoveID = subPersonListLiga2[args[0] - subPersonListReinstatedDriversLiga2.length - 1]
          }else{
            console.log(args[0])
      ...
      if(cmd == 'changecockpit2' && message.member.roles.cache.has(rennleiterRolleID)){
        ...
        .addFields(
          {name: 'Row 1', value: `0️⃣ - <@&${mercedesRoleIDLiga2}> und 1️⃣ - <@&${redBullRoleIDLiga2}>`},
          {name: 'Row 2', value: `0️⃣ - <@&${ferrariRoleIDLiga2}> und 1️⃣ - <@&${mcLarenRoleIDLiga2}>`},
          {name: 'Row 3', value: `0️⃣ - <@&${astonMartinRoleIDLiga2}> und 1️⃣ - <@&${alpineRoleIDLiga2}>`},
          {name: 'Row 4', value: `0️⃣ - <@&${alphaTauriRoleIDLiga2}> und 1️⃣ - <@&${alfaRomeoRoleIDLiga2}>`},
          {name: 'Row 5', value: `0️⃣ - <@&${williamsRoleIDLiga2}> und 1️⃣ - <@&${haasRoleIDLiga2}>`},
          {name: 'Abbrechen', value: `${abmeldenEmoji} - Um Vorgang abzubrechen`}
        )
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  ...
                  let preCmdDriver = currentLineupLiga2.get('Mercedes')[0]

                  currentLineupLiga2.get('Mercedes')[0] = driverInID
                  ...
                  if(preCmdDriver != 'nicht besetzt'){
                    ...
                    await client.guilds.cache.get(discordID).channels.cache.get(abmeldeChannelIDLiga2).send({ embeds : [clearCockpitRemoveEmbed]}).then(() => {
                  ...
                  await client.guilds.cache.get(discordID).channels.cache.get(anmeldeChannelIDLiga2).send({ embeds : [clearCockpitInEmbed]}).then(() => {
                  ...
                  driversSubInPerCommandLiga2.push(driverInID)
                  ...
                  if(subPersonListLiga2.includes(driverInID)){
                    subPersonListLiga2.splice(subPersonListLiga2.indexOf(driverInID), 1)
                  }
                  ...
                  let driverOutID = currentLineupLiga2.get('Mercedes')[0]
                  ...
                  freeCarsLiga2.push(mercedesRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, mercedesRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              }else if(reaction.emoji.name == '2️⃣'){
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Mercedes')[1]

                  currentLineupLiga2.get('Mercedes')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Mercedes')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
           ...
           */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Red Bull')[0]

                  currentLineupLiga2.get('Red Bull')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Red Bull')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(redBullRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, redBullRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Red Bull, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Red Bull')[1]

                  currentLineupLiga2.get('Red Bull')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Red Bull')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Ferrari')[0]

                  currentLineupLiga2.get('Ferrari')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Ferrari')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(ferrariRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, ferrariRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Ferrari, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Ferrari')[1]

                  currentLineupLiga2.get('Ferrari')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Ferrari')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('McLaren')[0]

                  currentLineupLiga2.get('McLaren')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('McLaren')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(mcLarenRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, mcLarenRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team McLaren, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('McLaren')[1]

                  currentLineupLiga2.get('McLaren')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('McLaren')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Aston Martin')[0]

                  currentLineupLiga2.get('Aston Martin')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Aston Martin')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(astonMartinRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, astonMartinRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Aston Martin, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Aston Martin')[1]

                  currentLineupLiga2.get('Aston Martin')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Aston Martin')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alpine')[0]

                  currentLineupLiga2.get('Alpine')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alpine')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(alpineRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, alpineRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Alpine, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alpine')[1]

                  currentLineupLiga2.get('Alpine')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alpine')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alpha Tauri')[0]

                  currentLineupLiga2.get('Alpha Tauri')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alpha Tauri')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(alphaTauriRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, alphaTauriRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Alpha Tauri, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alpha Tauri')[1]

                  currentLineupLiga2.get('Alpha Tauri')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alpha Tauri')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alfa Romeo')[0]

                  currentLineupLiga2.get('Alfa Romeo')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alfa Romeo')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(alfaRomeoRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, alfaRomeoRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Alfa Romeo, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Alfa Romeo')[1]

                  currentLineupLiga2.get('Alfa Romeo')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Alfa Romeo')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Williams')[0]

                  currentLineupLiga2.get('Williams')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Williams')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(williamsRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, williamsRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Williams, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Williams')[1]

                  currentLineupLiga2.get('Williams')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Williams')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
          ...
          */
            ...
            collectorConfirm.on('collect', async (reaction, user) => {
              ...
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Haas')[0]

                  currentLineupLiga2.get('Haas')[0] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Haas')[0]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
                  ...
                  freeCarsLiga2.push(haasRoleIDLiga2);
                  withdrawnDriversLiga2.push(driverOutID);
                  await removeFromCurrentLineup(driverOutObject, client, message, haasRoleIDLiga2);
                  await checkSubCanBeMade(client, message, false, null, null, null)
                }
              /**
              * Team Haas, Fahrer 2
              */
                ...
                if(args[0]){
                  driverInID = args[0].slice(2, 20)
                  let preCmdDriver = currentLineupLiga2.get('Haas')[1]

                  currentLineupLiga2.get('Haas')[1] = driverInID
                  ...
                  let driverOutID = currentLineupLiga2.get('Haas')[1]
                  let driverOutObject = await client.guilds.cache.get(discordID).members.fetch(`${driverOutID}`)
      ...
      if(cmd == 'shufflewaitlistup2' && message.member.roles.cache.has(rennleiterRolleID)){
        if(args[0]){
          ...
          if(subPersonListReinstatedDriversLiga2.includes(driverID)){
            positionIndex = subPersonListReinstatedDriversLiga2.indexOf(driverID)
            onReinsate = true
          }else if(subPersonListLiga2.includes(driverID)){
            positionIndex = subPersonListLiga2.indexOf(driverID)
            onNormal = true
          }else{
          ...
          if(positionIndex == null){
            ...
            if(onReinsate == true){
              if(positionIndex == subPersonListReinstatedDriversLiga2.length - 1){
                subPersonListReinstatedDriversLiga2[positionIndex] = subPersonListLiga2[0]
                subPersonListLiga2[0] = driverID
              }else{
                subPersonListReinstatedDriversLiga2[positionIndex] = subPersonListReinstatedDriversLiga2[positionIndex + 1]
                subPersonListReinstatedDriversLiga2[positionIndex + 1] = driverID
              }
            }else if(onNormal == true){
              if(positionIndex == subPersonListLiga2.length - 1){
                message.reply(`Ist schon ganz hinten du Wurst`)
              }else{
                subPersonListLiga2[positionIndex] = subPersonListLiga2[positionIndex + 1]
                subPersonListLiga2[positionIndex + 1] = driverID
              }
            }else{
              return
            }
      ...
      if(cmd == 'shufflewaitlistdown2' && !(message.member.roles.cache.has(rennleiterRolleID))){
        message.reply(`Der Command kann nur von der Rennleitung ausgeführt werden`).then(() => {
          let date = new Date().toLocaleString();
          console.log(`${message.member.user.username} hat probiert den shuffleWaitlistDown remove Command auszuführen, hat aber keine Berechtigung dafür -- ${date}`);
        })
      }
        ...
        if(args[0]){
          ...
          if(positionIndex == null){
            ...
            if(onReinsate == true){
              ...
              if(positionIndex == 0){
                subPersonListLiga2[0] = subPersonListReinstatedDriversLiga2[subPersonListReinstatedDriversLiga2.length - 1]
                subPersonListReinstatedDriversLiga2[subPersonListReinstatedDriversLiga2.length - 1] = driverID
              }else{
                subPersonListLiga2[positionIndex] = subPersonListLiga2[positionIndex - 1]
                subPersonListLiga2[positionIndex - 1] = driverID
              }
      ...
      if(cmd == 'shufflewaitlistlast2' && !(message.member.roles.cache.has(rennleiterRolleID))){
        message.reply(`Der Command kann nur von der Rennleitung ausgeführt werden`).then(() => {
          let date = new Date().toLocaleString();
          console.log(`${message.member.user.username} hat probiert den shuffleWaitlistDown remove Command auszuführen, hat aber keine Berechtigung dafür -- ${date}`);
        })
      ...
      if(cmd == 'shufflewaitlistlast2' && message.member.roles.cache.has(rennleiterRolleID)){
        if(args[0]){
          ...
          if(positionIndex == null){
            ...
            if(onReinsate == true){
              while(positionIndex <= subPersonListReinstatedDriversLiga2.length - 1){
                if(positionIndex == subPersonListReinstatedDriversLiga2.length - 1){
                  subPersonListReinstatedDriversLiga2[positionIndex] = subPersonListLiga2[0]
                  subPersonListLiga2[0] = driverID
                }else{
            ...
            positionIndex = 0
            while(positionIndex < subPersonListLiga2.length - 1){
      ...
      if(cmd == 'shufflewaitlistfirst2' && !(message.member.roles.cache.has(rennleiterRolleID))){
        message.reply(`Der Command kann nur von der Rennleitung ausgeführt werden`).then(() => {
          let date = new Date().toLocaleString();
          console.log(`${message.member.user.username} hat probiert den shuffleWaitlistDown remove Command auszuführen, hat aber keine Berechtigung dafür -- ${date}`);
        })
      ...
      if(cmd == 'shufflewaitlistfirst2' && message.member.roles.cache.has(rennleiterRolleID)){
        if(args[0]){
          ...
          if(positionIndex == null){
            ...
            if(subPersonListReinstatedDriversLiga2 == 0){
              ...
              positionIndex = subPersonListReinstatedDriversLiga2.length - 1
              while(positionIndex < 0){
      ...
      if(cmd == 'placedriveronwaitlist2' && !(message.member.roles.cache.has(rennleiterRolleID))){
        message.reply(`Der Command kann nur von der Rennleitung ausgeführt werden`).then(() => {
          let date = new Date().toLocaleString();
          console.log(`${message.member.user.username} hat probiert den shuffleWaitlistDown remove Command auszuführen, hat aber keine Berechtigung dafür -- ${date}`);
        })
      ...
      if(cmd == 'placedriveronwaitlist2' && message.member.roles.cache.has(rennleiterRolleID)){
        if(args[0]){
          ...
          if(subPersonListLiga2.includes(driverID) == false && subPersonListReinstatedDriversLiga2.includes(driverID) == false
            && await checkDriverInLineup(driverID) == false){
            subPersonListLiga2.push(driverID)
            await setWaitListMsgContent(client)
          }else{
