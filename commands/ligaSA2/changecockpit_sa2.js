...
module.exports = {
    ...
    async execute(client, interaction, command){
        ...
        if(!interaction.member.roles.cache.has(CurrentSeason.seasonData.getRennleiterRolleID()) &&
            ...
            console.log(`Der changecockpitSA2 Command wurde von ${interaction.user.username} verwendet -- ${date}`)
        }

        const driverIn = interaction.options.getUser('driver');
        const teamObject = interaction.options.getRole('team');
        const abmeldeChannel = CurrentSeason.seasonData.getAbmeldeChannelIDLigaSA2();
        ...
        var tempCurrentLineup = CurrentSeason.seasonData.getCurrentLineupLigaSA2();
        ...
        var tempSubInPerCmd = CurrentSeason.seasonData.getSubInDriversPerCommandLigaSA2();
        var tempFreeCars = CurrentSeason.seasonData.getFreeCarsLigaSA2();
        var tempWithdrawnDrivers = CurrentSeason.seasonData.getWithdrawnDriversLigaSA2();
            ...
            */
                ...
                if(driverIn){
                    ...
                    if(preCmdDriver != 'nicht besetzt'){
                        ...
                        CurrentSeason.seasonData.setWithdrawnDriversLigaSA2(tempWithdrawnDrivers);

                        let dateRemove = new Date().toLocaleString();
                        console.log(`changecockpitSA2 wurde verwendet und der Fahrer` +
                    ...
                    CurrentSeason.seasonData.setSubInDriversPerCommandLigaSA2(tempSubInPerCmd);

                    let dateIn = new Date().toLocaleString();
                    console.log(`changecockpitSA2 wurde verwendet und der Fahrer ${driverIn.username} wurde erfolgreich ins Lineup genommen -- ${dateIn}`);
                    ...
                    CurrentSeason.seasonData.setFreeCarsLigaSA2(tempFreeCars);
