...
module.exports = {
    ...
    async execute(client, interaction, command){
        ...
        if(!interaction.member.roles.cache.has(CurrentSeason.seasonData.getRennleiterRolleID()) &&
            ...
            console.log(`Der forceremoveSO2 Command wurde von ${interaction.user.username} verwendet -- ${date}`)
        }
        ...
        collectorConfirmSelectDriver.on('collect', async (reaction, user) => {
            ...
            if(reaction.emoji.name == '1️⃣'){
                ...
                CurrentSeason.seasonData.setCurrentLineupLigaSO2(tempLineup)
                // Stammlineup ändern
                ...
                collectorConfirmFutureRoles.on('collect', async (reaction, user) => {
                    ...
                    if(reaction.emoji.name == '1️⃣'){
                        ...
                        let regDriverRole = await interaction.guild.roles.cache.find(role => role.id === CurrentSeason.seasonData.getStammfahrerRolleIDLigaSO2());
