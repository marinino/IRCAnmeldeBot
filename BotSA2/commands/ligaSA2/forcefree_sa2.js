...
module.exports = {
    ...
    async execute(client, interaction, command){
        ...
        if(!interaction.member.roles.cache.has(CurrentSeason.seasonData.getRennleiterRolleID()) &&
            ...
            console.log(`Der forcefreeSA2 Command wurde von ${interaction.user.username} verwendet -- ${date}`)
        }
        ...
        if(tempCurrentLineup.get(teamRole.name)[0] == 'entfernt'){
            ...
            CurrentSeason.seasonData.setCurrentLineupLigaSA2(tempCurrentLineup);
